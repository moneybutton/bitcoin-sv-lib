...
<head>
  <meta charset="utf-8">
  <script src="bower_components/bitcore/bitcoin-sv-lib.min.js"></script>
...
<body>
  ...
  <script type="text/javascript">
    var bitcore = require('bitcoin-sv-lib');
...
```sh
browserify --require ./index.js:bitcoin-sv-lib | uglifyjs > bitcoin-sv-lib.min.js
```

```sh
browserify --require ./index.js:bitcore-mnemonic --external bitcoin-sv-lib | uglifyjs > bitcore-mnemonic.min.js
```
