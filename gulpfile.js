...
function startGulp (name, opts) {
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcoin-sv-lib -o ' + fullname + '.js'
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcoin-sv-lib -o bitcoin-sv-lib.js'
    }
